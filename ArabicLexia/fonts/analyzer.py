...
class FontAnalyzer:
    ...
    def _gather_data(self):
        # هذه الدالة الآن تجمع فقط البيانات الأفقية
    ...
    def analyze(self):
        ...
        self._gather_data() # تجمع البيانات الأفقية
        self.metrics.update(calculate_consistency_metrics(self))
        self.metrics.update(calculate_special_metrics(self))
        self.metrics.update(calculate_vertical_consistency(self)) # استدعاء الوحدة الجديدة
